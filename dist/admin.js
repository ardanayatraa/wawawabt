...
const ipKey = (request) => request.ip || request.socket.remoteAddress || 'unknown';
const isLoginLimited = (key) => {
    const now = Date.now();
...
const appHtml = (maxUploadMb) => String.raw `<!doctype html>
<html lang="id">
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
...
export const registerAdminRoutes = async (app, wa) => {
